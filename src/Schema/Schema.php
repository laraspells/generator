...
use LaraSpell\SchemaResolverInterface;
...
class Schema extends AbstractSchema
{
    ...
    {
        $dir = $this->get('repository.path').'/Contracts';
    ...
    {
        $dir = $this->get('repository.path').'/Eloquent';
        return $file? $dir.'/'.$file : $dir;
    }
    ...
    {
        return $this->get('repository.namespace');
    }
